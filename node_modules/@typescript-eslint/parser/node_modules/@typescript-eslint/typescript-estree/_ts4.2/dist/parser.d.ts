...
import type { ParserServices, ParserServicesNodeMaps, TSESTreeOptions } from './parser-options';
...
interface ParseWithNodeMapsResult<T extends TSESTreeOptions> extends ParserServicesNodeMaps {
    ast: AST<T>;
}
...
declare function parseAndGenerateServices<T extends TSESTreeOptions = TSESTreeOptions>(code: string | ts.SourceFile, options: T): ParseAndGenerateServicesResult<T>;
