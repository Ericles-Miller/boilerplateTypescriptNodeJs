 ...
 */
export declare function getTSNodeAccessibility(node: ts.Node): 'public' | 'protected' | 'private' | undefined;
/**
...
export declare function nodeHasIllegalDecorators(node: ts.Node): boolean;
/**
 * @param n the TSNode
 * @param ast the TS AST
 */
