...
var _Converter_instances, _Converter_checkIllegalDecorators, _Converter_throwUnlessAllowInvalidAST, _Converter_throwErrorIfDeprecatedPropertyExists;
...
class Converter {
    ...
    convertMethodSignature(node) {
        if ((0, node_utils_1.hasModifier)(SyntaxKind.ExportKeyword, node)) {
            __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'A method signature cannot have an export modifier.');
        }
        return this.createNode(node, {
    ...
    assertModuleSpecifier(node, allowNull) {
        if (!allowNull && node.moduleSpecifier == null) {
            __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'Module specifier must be a string literal.');
        }
        if (node.moduleSpecifier &&
            node.moduleSpecifier?.kind !== SyntaxKind.StringLiteral) {
            __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.moduleSpecifier.pos, 'Module specifier must be a string literal.');
        }
    }
    /**
     * Converts a TypeScript node into an ESTree node.
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.ThrowStatement:
                if (node.expression.end === node.expression.pos) {
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'A throw statement must throw an expression.');
                }
                return this.createNode(node, {
            ...
            case SyntaxKind.VariableStatement: {
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_checkIllegalDecorators).call(this, node);
                const result = this.createNode(node, {
                ...
                if (!result.declarations.length) {
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'A variable declaration list must have at least one variable declarator.');
                }
                /**
            ...
            case SyntaxKind.PropertyAssignment:
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.questionToken, 'A property assignment cannot have a question token.');
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.exclamationToken, 'A property assignment cannot have an exclamation token.');
                return this.createNode(node, {
            ...
            case SyntaxKind.ShorthandPropertyAssignment: {
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.modifiers, 'A shorthand property assignment cannot have modifiers.');
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.questionToken, 'A shorthand property assignment cannot have a question token.');
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.exclamationToken, 'A shorthand property assignment cannot have an exclamation token.');
            ...
            case SyntaxKind.Parameter: {
                ...
                if (modifiers) {
                    if ((0, node_utils_1.hasModifier)(SyntaxKind.ExportKeyword, node)) {
                        __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'A parameter cannot have an export modifier.');
                    }
                    return this.createNode(node, {
            ...
            case SyntaxKind.ClassDeclaration:
                if (!node.name &&
                    ...
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, "A class declaration without the 'default' modifier must have a name.");
                }
            ...
            case SyntaxKind.ClassExpression: {
                ...
                if (superClass && superClass.types.length > 1) {
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, superClass.types[1].pos, 'Classes can only extend a single class.');
                }
                ...
                if (superClass) {
                    ...
                    if (superClass.types[0]?.typeArguments) {
                        ...
                        result.superTypeArguments = result.superTypeParameters =
                            this.convertTypeArgumentsToTypeParameterInstantiation(superClass.types[0].typeArguments, superClass.types[0]);
                    }
                }
                return this.fixExports(node, result);
            }
            ...
            case SyntaxKind.BinaryExpression: {
                ...
                if ((0, node_utils_1.isComma)(node.operatorToken)) {
                    ...
                    return this.createNode(node, {
                        ...
                        left: this.converter(node.left, node, type === ts_estree_1.AST_NODE_TYPES.AssignmentExpression),
                        right: this.convertChild(node.right),
                    });
                }
            }
            ...
            case SyntaxKind.CallExpression: {
                if (node.expression.kind === SyntaxKind.ImportKeyword) {
                    if (node.arguments.length !== 1 && node.arguments.length !== 2) {
                        __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.arguments.pos, 'Dynamic import requires exactly one or two arguments.');
                    }
                    return this.createNode(node, {
            ...
            case SyntaxKind.PropertySignature: {
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.initializer, 'A property signature cannot have an initializer.');
                if ((0, node_utils_1.hasModifier)(SyntaxKind.ExportKeyword, node)) {
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'A property signature cannot have an export modifier.');
                }
                return this.createNode(node, {
            ...
            case SyntaxKind.IndexSignature: {
                if ((0, node_utils_1.hasModifier)(SyntaxKind.ExportKeyword, node)) {
                    __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'An index signature cannot have an export modifier.');
                }
                return this.createNode(node, {
            ...
            case SyntaxKind.FunctionType:
                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwErrorIfDeprecatedPropertyExists).call(this, node, 
                // eslint-disable-next-line deprecation/deprecation
                node.modifiers, 'A function type cannot have modifiers.');
            // intentional fallthrough
            ...
            case SyntaxKind.InterfaceDeclaration: {
                ...
                const result = this.createNode(node, {
                    ...
                    extends: interfaceHeritageClauses
                        ...
                        .flatMap(heritageClause => heritageClause.types.map(n => this.convertChild(n, node))),
                    id: this.convertChild(node.name),
                    typeParameters: node.typeParameters &&
                        this.convertTSTypeParametersToTypeParametersDeclaration(node.typeParameters),
                });
                    ...
                    ...(() => {
                        ...
                        if (node.flags & ts.NodeFlags.GlobalAugmentation) {
                            ...
                            if (body == null ||
                                ...
                                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, (node.body ?? node).pos, 'Expected a valid module body');
                            }
                            if (id.type !== ts_estree_1.AST_NODE_TYPES.Identifier) {
                                __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.name.pos, 'global module augmentation must have an Identifier id');
                            }
                            return {
                                kind: 'global',
                                body: body,
                        ...
                        if (node.body == null) {
                            __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'Expected a module body');
                        }
                        if (node.name.kind !== ts.SyntaxKind.Identifier) {
                            __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.name.pos, '`namespace`s must have an Identifier id');
                        }
...
_Converter_instances = new WeakSet(), _Converter_checkIllegalDecorators = function _Converter_checkIllegalDecorators(node) {
    if ((0, node_utils_1.nodeHasIllegalDecorators)(node)) {
        __classPrivateFieldGet(this, _Converter_instances, "m", _Converter_throwUnlessAllowInvalidAST).call(this, node.pos, 'Decorators are not valid here.');
    }
}, _Converter_throwUnlessAllowInvalidAST = function _Converter_throwUnlessAllowInvalidAST(pos, message) {
    if (!this.options.allowInvalidAST) {
        throw (0, node_utils_1.createError)(this.ast, pos, message);
    }
}, _Converter_throwErrorIfDeprecatedPropertyExists = function _Converter_throwErrorIfDeprecatedPropertyExists(node, property, message) {
    if (property) {
        throw (0, node_utils_1.createError)(this.ast, node.pos, message);
    }
};
